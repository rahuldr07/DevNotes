...
export function AuthLayout({ children, breadcrumb }: AuthLayoutProps) {
  return (
    ...
    >
      ...
      <div className="pointer-events-none absolute left-1/2 top-1/2 h-[34rem] w-[34rem] -translate-x-1/2 -translate-y-1/2 rounded-none auth-orb-3" />

      <div className="relative z-10 mx-auto flex w-full max-w-[1180px] items-center justify-between px-5 py-5 sm:px-8">
        <Link
          href="/"
          className="group flex items-center gap-2 rounded-none border px-3 py-2 text-sm shadow-sm backdrop-blur transition-all hover:-translate-y-0.5 hover:text-[var(--accent)]"
        ...
        <span
          className="hidden rounded-none border px-3 py-2 text-xs lowercase shadow-sm backdrop-blur sm:inline-flex"
      ...
      <div className="relative z-10 flex flex-1 flex-col items-center justify-center px-5 py-8 sm:px-6">
        <div className="mb-8 flex flex-col items-center gap-3 text-center sm:mb-10">
          <span
            className="rounded-none border px-4 py-2 text-2xl font-semibold lowercase shadow-sm backdrop-blur"
